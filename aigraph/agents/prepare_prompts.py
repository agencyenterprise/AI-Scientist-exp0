...
def build_prompt_prepare_metrics(task: Task, research: str = "") -> str:
    """Prompt for defining evaluation metrics with research context."""
    return f"""
    ## Introduction
...
def build_prompt_prepare_plan(
    task: Task, metrics: Iterable[Metric], research: str = ""
) -> str:
    """Prompt for creating structured experiment plan with research context."""
    return f"""
    ## Introduction
    ...
    Incorporate insights from the research context where relevant.
    """
